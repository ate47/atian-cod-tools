 ...
 * @param state ActsAPIFastFile_BDiffState state to keep between calls, should be initialized with zeros before the
 * first call.
...
/*
 * @return the current fastfile context used for the current handler, should be valid until the end of the handler
 * execution.
 */
