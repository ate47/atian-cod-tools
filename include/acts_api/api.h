...
#ifdef ACTS_COMMON_STATIC
#define ACTS_COMMON_API ACTS_EXTERN_C
#elif defined(ACTS_COMMON_DLL)
...
#define ACTS_COMMON_API ACTS_EXTERN_C
#else
#define ACTS_COMMON_API ACTS_EXTERN_C __attribute__((visibility("default")))
#endif
