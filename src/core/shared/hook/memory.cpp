...
namespace hook::memory {
    ...
    void* GetRelativeMemorySafe(void* location) { return platform::GetRelativeMemorySafe(location); }

    void* AllocateNearPage(void* location) { return platform::AllocateNearPage(location); }

    void* AllocateNear(void* location, size_t size) { return platform::AllocateNear(location, size); }
    ...
    void DumpMemory(void* location, size_t size) { platform::DumpMemory(location, size); }
