...
#define ThrowFastFileError(...) ThrowFastFileError_(std::format(__VA_ARGS__))
		...
		public:
			FFHandlerImpl() : fastfile::FFHandler(handlerId, handlerName, compatibility::scobalula::csi::CordycepGame::CG_VANGUARD) {
			...
			void Init(fastfile::FastFileOption& opt) override {
				...
				game.Get("DB_GetAssetSize", &gcx.DB_GetAssetSize);
