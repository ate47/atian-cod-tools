...
namespace fastfile {
    ...
    namespace flexible {
        ...
        inline PFFFastFileInfo& GetTrFastFileInfo(FlexibleFastFileReader& reader) {
            return *reader.GetChunkVal<PFFFastFileInfo>(SectionType::ST_FASTFILE_INFO, true);
        }
        inline PFPlatformData& GetTrPlatformData(FlexibleFastFileReader& reader) {
            return *reader.GetChunkVal<PFPlatformData>(SectionType::ST_PLATFORM_DATA, true);
        }
        inline PFFBuildData& GetTrBuildData(FlexibleFastFileReader& reader) {
            return *reader.GetChunkVal<PFFBuildData>(SectionType::ST_BUILD_DATA, true);
        }
        inline PFFLinkResult& GetTrLinkResult(FlexibleFastFileReader& reader) {
            return *reader.GetChunkVal<PFFLinkResult>(SectionType::ST_LINK_RESULT, true);
        }
        inline PFFSizeData& GetTrSizeData(FlexibleFastFileReader& reader) {
            return *reader.GetChunkVal<PFFSizeData>(SectionType::ST_SIZE_DATA, true);
        }
    } // namespace flexible
