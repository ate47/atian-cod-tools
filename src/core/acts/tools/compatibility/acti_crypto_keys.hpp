...
#define REGISTER_ACTI_KEY(name, version, ...)                                                                          \
    utils::ArrayAdder<AesKeyLocal> __##name##version {                                                                 \
        GetKeys(), AesKeyLocal {                                                                                       \
            #name, version, { __VA_ARGS__ }                                                                            \
        }                                                                                                              \
    }
#define REGISTER_ACTI_RSA_KEY(name, type, size, ...)                                                                   \
    utils::ArrayAdder<RsaKeyLocal> __##name {                                                                          \
        GetRsaKeys(), RsaKeyLocal {                                                                                    \
            #name, size, type, { __VA_ARGS__ }                                                                         \
        }                                                                                                              \
    }
