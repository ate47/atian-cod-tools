...
void* GetActsSharedConfig() { return core::shared_cfg::GetSharedConfigPtr(); }

void SetActsSharedConfig(void* cfg) { core::shared_cfg::SetSharedConfigPtr(cfg); }
    ...
    if (!hInstance) {
        ...
        if (cfgTitle == opt.showTitle) {
            LOG_INFO("Atian tools {} {}", core::actsinfo::VERSION, ([&opt]() -> const char* {
                         switch (opt.type) {
                         case actscli::ACTS_CLI:
                             return "CLI";
                         case actscli::ACTS_UI:
                             return "UI";
                         case actscli::ACTS_NUI:
                             return "NUI";
                         case actscli::ACTS_REPL:
                             return "REPL";
                         case actscli::ACTS_UI3:
                             return "UI3";
                         default:
                             return "";
                         }
