...
namespace systems::gsc::debug {
    namespace {
        ...
        std::array HudHAlignNames{ "subleft",    "left",        "center",     "right",
                                   "fullscreen", "noscale",     "alignto640", "center_safearea",
                                   "user_left",  "user_center", "user_right" };
        std::array HudVAlignNames{ "subtop",     "top",         "middle",     "bottom",
                                   "fullscreen", "noscale",     "alignto480", "center_safearea",
                                   "user_top",   "user_center", "user_bottom" };
...
#define __CREATE_GENERIC_HUDELEM_FIELD(field)                                                                          \
    HudElemField {                                                                                                     \
        .canonId = hash::HashT89Scr(#field), .type = bo4::GetFieldType<decltype(ScrHudElem::field)>(),                 \
        .ofs = offsetof(ScrHudElem, field), .size = sizeof(ScrHudElem::field),                                         \
    }
#define __CREATE_HUDELEM_FIELD(field, _getter, _setter)                                                                \
    HudElemField { .canonId = hash::HashT89Scr(#field), .setter = _setter, .getter = _getter, }
...
#undef __CREATE_GENERIC_HUDELEM_FIELD
        ...
        std::array actsGscDebugMethods{
            bo4::BuiltinFunctionDef{ .canonId = hash::HashT89Scr("settext"),
                                     .min_args = 1,
                                     .max_args = 0x7FFFFFFF,
                                     .actionFunc = HECmd_SetText,
                                     .type = bo4::BUILTIN_DEFAULT },
            bo4::BuiltinFunctionDef{ .canonId = hash::HashT89Scr("setshader"),
                                     .min_args = 1,
                                     .max_args = 3,
                                     .actionFunc = HECmd_SetMaterial,
                                     .type = bo4::BUILTIN_DEFAULT },
            bo4::BuiltinFunctionDef{ .canonId = hash::HashT89Scr("settargetent"),
                                     .min_args = 1,
                                     .max_args = 1,
                                     .actionFunc = HECmd_SetTargetEnt,
                                     .type = bo4::BUILTIN_DEFAULT },
            bo4::BuiltinFunctionDef{ .canonId = hash::HashT89Scr("cleartargetent"),
                                     .min_args = 0,
                                     .max_args = 0,
                                     .actionFunc = HECmd_ClearTargetEnt,
                                     .type = bo4::BUILTIN_DEFAULT },
            bo4::BuiltinFunctionDef{ .canonId = hash::HashT89Scr("settimer"),
                                     .min_args = 1,
                                     .max_args = 1,
                                     .actionFunc = HECmd_SetTimer,
                                     .type = bo4::BUILTIN_DEFAULT },
            bo4::BuiltinFunctionDef{ .canonId = hash::HashT89Scr("settenthstimer"),
                                     .min_args = 1,
                                     .max_args = 1,
                                     .actionFunc = HECmd_SetTenthsTimer,
                                     .type = bo4::BUILTIN_DEFAULT },
            bo4::BuiltinFunctionDef{ .canonId = hash::HashT89Scr("setvalue"),
                                     .min_args = 1,
                                     .max_args = 1,
                                     .actionFunc = HECmd_SetValue,
                                     .type = bo4::BUILTIN_DEFAULT },
            bo4::BuiltinFunctionDef{ .canonId = hash::HashT89Scr("setwaypoint"),
                                     .min_args = 1,
                                     .max_args = 4,
                                     .actionFunc = HECmd_SetWaypoint,
                                     .type = bo4::BUILTIN_DEFAULT },
            bo4::BuiltinFunctionDef{ .canonId = hash::HashT89Scr("fadeovertime"),
                                     .min_args = 1,
                                     .max_args = 1,
                                     .actionFunc = HECmd_FadeOverTime,
                                     .type = bo4::BUILTIN_DEFAULT },
            bo4::BuiltinFunctionDef{ .canonId = hash::HashT89Scr("scaleovertime"),
                                     .min_args = 3,
                                     .max_args = 3,
                                     .actionFunc = HECmd_ScaleOverTime,
                                     .type = bo4::BUILTIN_DEFAULT },
            bo4::BuiltinFunctionDef{ .canonId = hash::HashT89Scr("moveovertime"),
                                     .min_args = 1,
                                     .max_args = 1,
                                     .actionFunc = HECmd_MoveOverTime,
                                     .type = bo4::BUILTIN_DEFAULT },
            bo4::BuiltinFunctionDef{ .canonId = hash::HashT89Scr("destroy"),
                                     .min_args = 0,
                                     .max_args = 0,
                                     .actionFunc = HECmd_Destroy,
                                     .type = bo4::BUILTIN_DEFAULT },
            bo4::BuiltinFunctionDef{ .canonId = hash::HashT89Scr("setpulsefx"),
                                     .min_args = 3,
                                     .max_args = 3,
                                     .actionFunc = HECmd_SetPulseFX,
                                     .type = bo4::BUILTIN_DEFAULT },
            bo4::BuiltinFunctionDef{ .canonId = hash::HashT89Scr("setcod7decodefx"),
                                     .min_args = 3,
                                     .max_args = 3,
                                     .actionFunc = HECmd_SetCOD7DecodeFX,
                                     .type = bo4::BUILTIN_DEFAULT },
            bo4::BuiltinFunctionDef{ .canonId = hash::HashT89Scr("setplayernamestring"),
                                     .min_args = 1,
                                     .max_args = 1,
                                     .actionFunc = HECmd_SetPlayerNameString,
                                     .type = bo4::BUILTIN_DEFAULT },
            bo4::BuiltinFunctionDef{ .canonId = hash::HashT89Scr("changefontscaleovertime"),
                                     .min_args = 1,
                                     .max_args = 1,
        ...
        bool R_IsInit() { return bo4::sharedUiInfo->assets.whiteMaterial && bo4::sharedUiInfo->assets.bigFont; }
        ...
        void RenderFrame() {
            ...
            for (ScrHudElem& elem : dbgData.huds) {
                ...
                case HHA_SUBLEFT:
                    x = (x * scrPlace->scaleVirtualToReal[0]);
                    break;
                case HHA_LEFT:
                    x = (x * scrPlace->scaleVirtualToReal[0]) + scrPlace->realViewableMin[0];
                    break;
                case HHA_CENTER:
                    x = ((x * scrPlace->scaleVirtualToReal[0]) + (scrPlace->realViewportSize[0] * elem.fontScale)) +
                ...
                case HVH_RIGHT:
                    ...
                    break;
                case HHA_FULLSCREEN:
                    x = (x * scrPlace->scaleVirtualToFull[0]) + scrPlace->realViewportBase[0];
                    break;
                case HHA_NOSCALE:
                    x = x;
                    break;
                case HHA_ALIGNTO640:
                    ...
                    break;
                case HHA_CENTER_SAFEAREA:
                    x = (x * scrPlace->scaleVirtualToReal[0]) +
                        ((scrPlace->realViewableMin[0] + scrPlace->realViewableMax[0]) * elem.fontScale);
                    break;
                case HHA_USER_LEFT:
                    x = (x * scrPlace->scaleVirtualToReal[0]) + scrPlace->realTweakableMin[0];
                    ;
                    break;
                case HHA_USER_CENTER:
                    x = (x * scrPlace->scaleVirtualToReal[0]) +
                        ((scrPlace->realTweakableMin[0] + scrPlace->realTweakableMax[0]) * elem.fontScale);
                    break;
                case HHA_USER_RIGHT:
                    x = (x * scrPlace->scaleVirtualToReal[0]) + scrPlace->realTweakableMax[0];
                    break;
                default:
                    x = x;
                    break;
                ...
                case HVA_SUBTOP:
                    y = (y * scrPlace->scaleVirtualToReal[0]);
                    break;
                case HVA_TOP:
                    y = (y * scrPlace->scaleVirtualToReal[1]) + scrPlace->realViewableMin[1];
                    break;
                case HVA_MIDDLE:
                    y = ((y * scrPlace->scaleVirtualToReal[1]) + (scrPlace->realViewportSize[1] * elem.fontScale)) +
                ...
                case HVA_BOTTOM:
                    ...
                    break;
                case HVA_FULLSCREEN:
                    y = (y * scrPlace->scaleVirtualToFull[1]) + scrPlace->realViewportBase[1];
                    break;
                case HVA_NOSCALE:
                    y = y;
                    break;
                case HVA_ALIGNTO480:
                    ...
                    break;
                case HVA_CENTER_SAFEAREA:
                    y = (y * scrPlace->scaleVirtualToReal[1]) +
                        ((scrPlace->realViewableMin[1] + scrPlace->realViewableMax[1]) * elem.fontScale);
                    break;
                case HVA_USER_TOP:
                    y = (y * scrPlace->scaleVirtualToReal[1]) + scrPlace->realTweakableMin[1];
                    ;
                    break;
                case HVA_USER_CENTER:
                    y = (y * scrPlace->scaleVirtualToReal[1]) +
                        ((scrPlace->realTweakableMin[1] + scrPlace->realTweakableMax[1]) * elem.fontScale);
                    break;
                case HVA_USER_BOTTOM:
                    y = (y * scrPlace->scaleVirtualToReal[1]) + scrPlace->realTweakableMax[1];
                    break;
                default:
                    y = x;
                    break;
