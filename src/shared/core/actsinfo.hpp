...
namespace core::actsinfo {
    ...
    constexpr const char* VERSION = "2.3.1";
    constexpr const wchar_t* VERSIONW = L"2.3.1";
    constexpr unsigned int VERSION_ID = 0x2003010;
    ...
    // prerelease
    constexpr const char* VERSION = "2.3.1-pre";
    constexpr const wchar_t* VERSIONW = L"2.3.1-pre";
