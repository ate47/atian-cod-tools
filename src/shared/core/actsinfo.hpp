...
namespace core::actsinfo {
    ...
    constexpr const char* VERSION = "2.8.0";
    constexpr const wchar_t* VERSIONW = L"2.8.0";
    constexpr unsigned int VERSION_ID = 0x2008000;
    ...
    // prerelease
    constexpr const char* VERSION = "2.8.0-pre";
    constexpr const wchar_t* VERSIONW = L"2.8.0-pre";
