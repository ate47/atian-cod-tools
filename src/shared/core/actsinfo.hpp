...
namespace core::actsinfo {
    ...
    constexpr const wchar_t* VERSIONW = L"2.4.0";
    constexpr unsigned int VERSION_ID = 0x2004000;
    ...
    // prerelease
    constexpr const char* VERSION = "2.4.0-pre";
    constexpr const wchar_t* VERSIONW = L"2.4.0-pre";
