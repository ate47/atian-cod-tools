...
namespace tool::gsc::opcode {
	void RegisterOpCodesMap() {
		...
		std::call_once(f, [] {
			...
			RegisterOpCode(VM_T7, PLATFORM_PC, OPCODE_ScriptFunctionCallPointer, 0x26b, 0x2ce, 0x2db, 0x2fd, 0x36b, 0x3f2, 0x4d3, 0x566, 0x5ca, 0x5d2, 0x650, 0x653, 0x67c, 0x9f3, 0xbd3, 0xbdf, 0xc33, 0xd32, 0xe14, 0x1166, 0x143c, 0x169d, 0x16a2, 0x1704, 0x180b, 0x1905, 0x197e, 0x19bb, 0x1a83, 0x1acc, 0x1e9f, 0x1ede);
