...
namespace {
    ...
    public:
        T71AGSCOBJHandler(byte* file, size_t fileSize) : GSCOBJHandler(file, fileSize, GOHF_STRING_NAMES | GOHF_INLINE_FUNC_PTR | GOHF_SUPPORT_VAR_VA | GOHF_SUPPORT_VAR_REF | GOHF_FOREACH_TYPE_T7 | GOHF_SUPPORT_GET_API_SCRIPT | GOHF_SWITCH_TYPE_T7) {}
        ...
        void SetHeader() override {
            Ref<uint64_t>() = 0x1a000a0d43534780;
        }
        void SetExportsCount(uint16_t val) override {
            Ptr<T7GSCOBJ>()->export_count = val;
        }
...
REGISTER_GSC_VM(VMI_T7_1C, T7GSCOBJHandler);
REGISTER_GSC_VM(VMI_T7_1B, T71BGSCOBJHandler);
REGISTER_GSC_VM(VMI_T7_1A, T71AGSCOBJHandler);