...
namespace {
	...
	void OpCode() {
		VmInfo* vt71b = RegisterVM(VMI_T7_1B, "Call of Duty: Black ops 3 (1B)", "t7", "bo3_1b", VmFlags::VMF_CLIENT_VM | VmFlags::VMF_NO_FILE_NAMESPACE | VmFlags::VMF_ALIGN | VmFlags::VMF_ANIMTREE_T7 | VmFlags::VMF_HASH_T7 | VmFlags::VMF_ISTRING); // | VmFlags::VMF_CALL_NO_PARAMS
