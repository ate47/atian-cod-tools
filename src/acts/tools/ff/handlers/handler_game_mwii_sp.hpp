...
namespace fastfile::handlers::mwiisp {
	...
	constexpr const char* gamePath = "mwiisp";
	constexpr const char* gameExe = "sp22-cod_dump.exe";
	constexpr const char* gameDumpId = "mw2sp";
	constexpr const char* handlerId = "mwiisp";
	constexpr const char* handlerName = "Modern Warfare II Campaign";
