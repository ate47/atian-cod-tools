...
REGISTER_GSC_VM(VMI_T8_36, T8GSCOBJHandler);
REGISTER_GSC_VM(VMI_T8_35, T835GSCOBJHandler);
REGISTER_GSC_VM(VMI_T8_34, T834GSCOBJHandler);
REGISTER_GSC_VM(VMI_T8_31, T831GSCOBJHandler);
