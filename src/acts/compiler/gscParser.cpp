...
void gscParserInitialize() {
  ...
  static const int32_t serializedATNSegment[] = {
  	4,1,91,639,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
  	...
  	84,86,88,90,0,16,1,0,1,2,2,0,87,87,89,89,1,0,14,15,1,0,31,33,1,0,34,35,
  	1,0,36,38,2,0,16,16,42,52,1,0,57,60,1,0,61,64,1,0,61,62,1,0,65,66,1,0,
  	67,68,2,0,14,14,69,70,1,0,71,72,1,0,73,74,1,0,79,82,686,0,97,1,0,0,0,
  	...
  	3,1,0,0,0,106,107,5,4,0,0,107,108,5,87,0,0,108,109,5,3,0,0,109,5,1,0,
  	...
  	5,87,0,0,128,130,5,12,0,0,129,125,1,0,0,0,129,130,1,0,0,0,130,131,1,0,
  	0,0,131,132,5,87,0,0,132,133,5,8,0,0,133,134,3,8,4,0,134,135,5,9,0,0,
  	...
  	1,0,0,0,150,153,5,87,0,0,151,152,5,16,0,0,152,154,3,42,21,0,153,151,1,
  	...
  	0,0,0,175,176,5,19,0,0,176,15,1,0,0,0,177,178,5,87,0,0,178,180,5,20,0,
  	...
  	221,5,8,0,0,221,224,5,87,0,0,222,223,5,13,0,0,223,225,5,87,0,0,224,222,
  	...
  	0,319,320,5,87,0,0,320,322,5,39,0,0,321,319,1,0,0,0,321,322,1,0,0,0,322,
  	323,1,0,0,0,323,339,5,87,0,0,324,325,5,11,0,0,325,326,5,11,0,0,326,327,
  	...
  	12,0,0,335,336,5,40,0,0,336,337,5,87,0,0,337,339,1,0,0,0,338,321,1,0,
  	0,0,338,324,1,0,0,0,338,330,1,0,0,0,339,39,1,0,0,0,340,343,5,84,0,0,341,
  	344,5,87,0,0,342,344,3,42,21,0,343,341,1,0,0,0,343,342,1,0,0,0,343,344,
  	1,0,0,0,344,41,1,0,0,0,345,354,3,44,22,0,346,347,3,46,23,0,347,348,5,
  	41,0,0,348,349,3,42,21,0,349,350,5,20,0,0,350,351,3,42,21,0,351,354,1,
  	...
  	363,10,2,0,0,363,364,5,53,0,0,364,366,3,48,24,0,365,362,1,0,0,0,366,369,
  	...
  	0,374,375,5,54,0,0,375,377,3,50,25,0,376,373,1,0,0,0,377,380,1,0,0,0,
  	...
  	5,55,0,0,386,388,3,52,26,0,387,384,1,0,0,0,388,391,1,0,0,0,389,387,1,
  	0,0,0,389,390,1,0,0,0,390,51,1,0,0,0,391,389,1,0,0,0,392,393,6,26,-1,
  	0,393,394,3,54,27,0,394,400,1,0,0,0,395,396,10,2,0,0,396,397,5,56,0,0,
  	...
  	0,501,73,1,0,0,0,502,503,6,37,-1,0,503,507,5,87,0,0,504,507,3,78,39,0,
  	505,507,3,76,38,0,506,502,1,0,0,0,506,504,1,0,0,0,506,505,1,0,0,0,507,
  	524,1,0,0,0,508,509,10,2,0,0,509,515,5,75,0,0,510,516,5,87,0,0,511,512,
  	...
  	0,545,551,5,75,0,0,546,552,5,87,0,0,547,548,5,8,0,0,548,549,3,42,21,0,
  	...
  	3,84,42,0,557,564,5,85,0,0,558,564,5,83,0,0,559,564,5,90,0,0,560,564,
  	5,91,0,0,561,564,5,86,0,0,562,564,3,82,41,0,563,553,1,0,0,0,563,554,1,
  	...
  	1,0,0,0,565,568,5,15,0,0,566,567,5,87,0,0,567,569,5,39,0,0,568,566,1,
  	0,0,0,568,569,1,0,0,0,569,570,1,0,0,0,570,581,5,87,0,0,571,572,5,76,0,
  	0,572,573,5,87,0,0,573,574,5,61,0,0,574,575,5,89,0,0,575,576,5,63,0,0,
  	576,577,5,39,0,0,577,581,5,87,0,0,578,579,5,15,0,0,579,581,3,74,37,0,
  	...
  	0,0,0,616,617,5,12,0,0,617,89,1,0,0,0,618,634,5,18,0,0,619,620,5,88,0,
  	0,620,621,5,20,0,0,621,628,3,42,21,0,622,623,5,13,0,0,623,624,5,88,0,
...
gscParser::Expression_listContext* gscParser::expression_list() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if ((((_la & ~ 0x3fULL) == 0) &&
      ((1ULL << _la) & 15032682752) != 0) || ((((_la - 71) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 71)) & 1695535) != 0)) {
      setState(158);
      expression();
      setState(163);
      _errHandler->sync(this);
...
gscParser::Statement_blockContext* gscParser::statement_block() {
  ...
  try {
    ...
    _la = _input->LA(1);
    while ((((_la & ~ 0x3fULL) == 0) &&
      ((1ULL << _la) & 547975629056) != 0) || ((((_la - 71) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 71)) & 1703727) != 0)) {
      setState(169);
      statement();
      setState(174);
      _errHandler->sync(this);
  ...
  try {
    ...
    while (alt != 2 && alt != atn::ATN::INVALID_ALT_NUMBER) {
      if (alt == 1) {
        ...
        _la = _input->LA(1);
        if (!(((((_la - 14) & ~ 0x3fULL) == 0) &&
          ((1ULL << (_la - 14)) & 108086391056891905) != 0))) {
        _errHandler->recoverInline(this);
        }
        else {
          _errHandler->reportMatch(this);
